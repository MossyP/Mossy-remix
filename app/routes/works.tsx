...
const WORKS_DATA: Work[] = [
    ...
    },
    {
        ...
        category: "Music",
        thumbnail: "/Works/Music/zure.png",
    ...
    },
    {
        ...
        category: "Firm",
        thumbnail: "/Works/Firm/mainori.png",
    ...
    },
    {
        ...
        category: "Firm",
        thumbnail: "/Works/Firm/yaminabe.png",
    ...
    // MV -> Firm
    {
        ...
        title: "にゅーげいん Vol.1",
        category: "Music",
        thumbnail: "/Works/Music/newgain.png",
        imageUrl: "/Works/Music/newgain.png",
        linkcoUrl: "https://linkco.re/embed/DAxCqV2g",
        description: "ニコニコ超会議2025にて頒布したコンピレーションアルバムです",
        date: "2024.05",
        url: "https://linkco.re/embed/DAxCqV2g                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ",
    },
    {
        id: "6",
        title: "七夕音楽祭2024/2025",
        category: "Event",
        thumbnail: "/Works/Event/tanabata.jpg",
    ...
    },
    {
        ...
        title: "一週間で曲作ってみた",
        category: "Music",
        thumbnail: "/Works/Music/issyuu.png",
                        ...
                        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8">
                            ...
                            <div className="w-full lg:w-2/3">
                                {(() => {
                                    ...
                                    } else if (selectedWork.linkcoUrl) {
                                        return (
                                            <div className="flex justify-center">
                                                <iframe
                                                    title={`${selectedWork.title} - Linkco embed`}
                                                    src={selectedWork.linkcoUrl}
                                                    width="300"
                                                    height="600"
                                                    className="border-0"
                                                />
